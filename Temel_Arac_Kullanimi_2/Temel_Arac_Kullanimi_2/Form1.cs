...
namespace Temel_Arac_Kullanimi_2
{
    public partial class Form1 : Form
    {
        ...
        {
            MessageBox.Show("Bu uygulamayı Turkcell Geleceğe Yazanlar Platformu dersleri altında gerçekleştirmekteyiz.",
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            if (sure >= 0 && sure <= 30)
            {
                ...
                panel3.BackColor = Color.Transparent;   //Transparent = yeşil ışık gider.
            }
            if (sure > 30 && sure <= 40)
            {
